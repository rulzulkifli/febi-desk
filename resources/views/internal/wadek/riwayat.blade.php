...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <form action="{{ url()->current() }}" method="GET" class="d-flex w-25">
            <div class="input-group shadow-sm">
                ...
                <input type="text" name="search" class="form-control border-start-0 border-end-0" placeholder="Cari Nama / NIM..." value="{{ request('search') }}">
    ...
    <!-- Navigasi Tabs -->
    <ul class="nav nav-pills mb-4 bg-white p-2 rounded-pill shadow-sm border" id="wadekRiwayatTabs" role="tablist" style="width: fit-content;">
        <li class="nav-item" role="presentation">
            <button class="nav-link active fw-bold px-4 rounded-pill d-flex align-items-center" id="riwayat-pembimbing-tab" data-bs-toggle="pill"
                data-bs-target="#riwayat-pembimbing" type="button" role="tab">
                <i class="bi bi-person-check-fill me-2"></i> SK Pembimbing
            </button>
        </li>
        <li class="nav-item ms-2" role="presentation">
            <button class="nav-link fw-bold px-4 rounded-pill d-flex align-items-center" id="riwayat-penguji-tab" data-bs-toggle="pill"
                data-bs-target="#riwayat-penguji" type="button" role="tab">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($item->status == 'selesai')
                                            <span class="badge bg-success-subtle text-success fw-semibold px-3 py-2 rounded-pill">Selesai</span>
                                        @endif
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-5">
                                        <i class="bi bi-clock-history d-block fs-2 mb-2 text-black-50"></i> Belum ada riwayat validasi SK Pembimbing.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    <table class="table align-middle mb-0 bg-white shadow-sm rounded-4 overflow-hidden">
                        ...
                        <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1 d-flex flex-column gap-1" style="font-size: 12px; font-weight: 500;">
                                                    @if ($item->ketuaPenguji)
                                                        <span class="text-danger"><i class="bi bi-person-badge-fill"></i> Ketua: {{ $item->ketuaPenguji->nama_dosen ?? ($item->ketuaPenguji->nama ?? $item->ketuaPenguji->name) }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-5">
                                        <i class="bi bi-clock-history d-block fs-2 mb-2 text-black-50"></i> Belum ada riwayat validasi SK Ujian.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
